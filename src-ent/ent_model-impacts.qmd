...
ggpairs(dat %>% select(Sw, Sw_r, cntxt_odds, succss_odds))
```
...
fit <- glm(door_m ~ scale(Sw) + scale(Sw_r) + scale(succss_odds) + scale(cntxt_odds), data=dat, family=binomial(link="logit"))
summary(fit)
```
